<div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="row ">
                        <div class="col-md-6">
                            <ul>
                                ...
                                <li>Microsoft Windows Laptop Repair</li>
                                <li>Data Recovery</li>
                ...
                <div class="col-md-4 text-center">
                    <div class="text-center align-self-center">
                        <img src="{{asset('assets/images/slider/about-img-02.jpg')}}" class="d-block w-75" alt="...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-3 bg-light">
        <div class="container">
            <div class="row justify-content-center">
                <h2 class="text-center py-3">Our Advantages</h2>
                <div class="col-md-3 text-center">
                    <h4><i class="fa-solid fa-location-dot"></i> Any Place</h4>
                </div>
                <div class="col-md-3 text-center">
                    <h4><i class="fa-solid fa-desktop"></i> Any Screen Size</h4>
                </div>
                <div class="col-md-3 text-center">
                    <h4><i class="fa-solid fa-award "></i> Quality Parts Only</h4>
                </div>
                <div class="col-md-3 text-center">
                    <h4><i class="fa-solid fa-calendar-days"></i> 7 Days a Week</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center py-3">
                <div class="col-md-6">
                    ...
                    <p>If we can't fix your computer then you don't owe us a penny!</p>
                    <div class="row py-2">
                        <div class="col-md-4">
                            <div class="text-center align-self-center">
                                <img src="{{asset('assets/images/slider/about-img-01.jpg')}}" class="d-block w-100" alt="...">
                            </div>
                        </div>
                        <div class="col-md-8">
                ...
                <div class="col-md-6">
                    ...
                    <p>We promise delivering vital service and to deliver it perfectly</p>
                    <div class="row py-2">
                        <div class="col-md-4">
                            <div class="text-center align-self-center">
                                <img src="{{asset('assets/images/slider/about-img-02.jpg')}}" class="d-block w-100" alt="...">
                            </div>
                        </div>
                        <div class="col-md-8">
