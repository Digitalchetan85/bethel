                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <li><a class="dropdown-item" href="{{ route('services.laptop-repair') }}">Laptop Repair</a>
                          </li>
                          <li><a class="dropdown-item" href="{{ route('services.pc-repair') }}">PC Repair</a>
                          </li>
                          <li><a class="dropdown-item" href="{{ route('services.mac-repair') }}">Mac Repair</a>
                          </li>
                          <li><a class="dropdown-item" href="{{ route('services.data-backup') }}">Data Backup and Recovery</a>
                          </li>
                          <li><a class="dropdown-item" href="{{ route('services.software-installation') }}">Software Installation</a>
                          </li>
